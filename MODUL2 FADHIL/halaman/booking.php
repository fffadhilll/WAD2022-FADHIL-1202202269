      ...
      <div class="col-6">
        <form method='GET' action='my_booking.php'>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control bg-secondary text-light" id="nama" readonly value="Fadhil_1202202269" name="nama" />
          </div>
          ...
          <div class="mb-3">
            ...
            <select class="form-select" aria-label="Default select example" id="car-type" name="car-type">
          ...
          <div class="mb-3">
            ...
            <div class="form-check">
              ...
              <input class="form-check-input" type="checkbox" id="health" name="services[]" value="Health Protocol" />
            ...
            <div class="form-check">
              ...
              <input class="form-check-input" type="checkbox" id="driver" name="services[]" value="Driver" />
            ...
            <div class="form-check">
              ...
              <input class="form-check-input" type="checkbox" id="fuel" name="services[]" value="Fuel" />
              <label class="form-check-label" for="flexCheckChecked">
