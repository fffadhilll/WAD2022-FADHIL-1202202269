...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 27, 2022 at 03:05 PM
...
(63, 'BMW baru 2', 'siapa aja deh', 'BMW 10', '0000-00-00', 'adsads', 'agya.png', 'Lunas');
...
--
ALTER TABLE `showroom_fadhil_table`
  MODIFY `id_mobil` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
COMMIT;
